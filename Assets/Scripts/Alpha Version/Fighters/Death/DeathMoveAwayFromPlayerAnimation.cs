...
public class DeathMoveAwayFromPlayerAnimation : StateMachineBehaviour
{
    ...
    private void FloatAwayFromThePlayer()
    {
        Vector2 playerPosition = playerTransform.position;
        Vector2 newPosition = Vector2.MoveTowards(deathTransform.position, playerPosition, -1 * speed * Time.fixedDeltaTime);
